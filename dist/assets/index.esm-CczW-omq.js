 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qe{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(Xe(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function Xe(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const S="@firebase/app",x="0.16.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */zt("");export{Ut as A,Vt as B,ne as C,A as D,Kt as E,w as F,Yt as G,te as H,l as I,se as J,Wt as K,xe as L,Jt as M,we as N,Gt as O,jt as P,I as Q,Zt as R,cn as S,J as _,rn as a,g as b,an as c,v as d,St as e,le as f,on as g,At as h,Tt as i,k as j,sn as k,E as l,Rt as m,hn as n,fn as o,ln as p,dn as q,D as r,un as s,Xt as t,Qt as u,qt as v,en as w,M as x,tn as y,nn as z};
